 ...
 * {@link org.opennms.tools.jmxconfiggenerator.jmxconfig.JmxDatacollectionConfiggenerator}. Therefore the API of the
 * <code>JmxDatacollectionConfiggenerator</code> can be used and in addition it is possible to provide further
 * information for additional stuff in the future.
 *
 * @author marskuh
 */
